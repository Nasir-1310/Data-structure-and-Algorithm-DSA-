...
void print_inorder(struct node*root)
{
    ...
    struct node*Extract_max(struct node*root)
    {
        struct node*temp;
        temp=root;
   ...
   struct node*Extracct_successor(struct node*root,int item)
   {
   ...
   struct node*delate_node(struct node*root,int item)
   {
       ...
       else if(node->right==NULL)
       {
        ...
        struct node*min_node=Extracct_successor(root,item);
